...
public class Fragment_SalesHistory extends Fragment implements Salesitemadapter.OnItemClickListener {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater,@Nullable ViewGroup container,@Nullable Bundle savedInstanceState) {
                View view = inflater.inflate(R.layout.saleshistoryfragment,container,false);
                backbtn=view.findViewById(R.id.saleshisbackbtn);
                recyclerView=view.findViewById(R.id.historyrview2);
